...
import com.ishansong.bigdata.statistics.data.DynamicObject;
 ...
 *
 */
public class DynamicSchema implements DeserializationSchema<DynamicObject> {

    @Override
    public DynamicObject deserialize(byte[] message) throws IOException {
        ...
        DynamicObject gpsObj = null;
        try {
            gpsObj = new DynamicObject();
    ...
    @Override
    public boolean isEndOfStream(DynamicObject nextElement) {
        return false;
    }
     ...
     */
    @Override
    public TypeInformation<DynamicObject> getProducedType() {
        return TypeInformation.of(DynamicObject.class);
    }
