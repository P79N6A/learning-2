...
public class CuratorFrameworkImpl implements CuratorFramework {
    ...
    /**
     * 检查zk连接状态，并调用 {@link ConnectionStateManager#addStateChange(ConnectionState)} 添加zk连接状态
     *
     * @param state
     */
