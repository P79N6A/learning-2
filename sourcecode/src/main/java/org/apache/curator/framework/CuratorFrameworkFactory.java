...
public class CuratorFrameworkFactory {
    ...
    public static class Builder {
         ...
         * {@link #authorization(String, byte[])} for backward compatibility.
         * <p/>
         * Subsequent calls to this method overwrite the prior calls.
         *
         ...
         * but not both.
         * <p>
         * 默认FixedEnsembleProvider
         *
         * @param connectString list of servers to connect to
         * @return this
         */
        public Builder connectString(String connectString) {
            // ExhibitorEnsembleProvider config demo
//            Collection<String> hostnames = Arrays.asList("127.0.0.1");
//            int port = 2181;
//            Exhibitors.BackupConnectionStringProvider backupConnectionStringProvider = () -> connectString;
//            Exhibitors exhibitors = new Exhibitors(hostnames, port, backupConnectionStringProvider);
//            ExhibitorEnsembleProvider exhibitorEnsembleProvider = new ExhibitorEnsembleProvider(exhibitors, new DefaultExhibitorRestClient(), "restUriPath", 100, this.getRetryPolicy());
//            ensembleProvider = exhibitorEnsembleProvider;
         ...
         * with the namespace
         * <p>
         * 由于ZooKeeper是共享空间，因此给定群集的用户应保留在预定义的命名空间内。
         * 如果在此处设置了命名空间，则所有路径都将使用命名空间预先设置
         * <p>
         * 通常设置为模块名称或项目名称
         *
