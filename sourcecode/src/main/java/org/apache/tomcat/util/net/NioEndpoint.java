...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel, SocketChannel> {
    ...
    public void startInternal() throws Exception {
        ...
        if (!running) {
            ...
            // 设置最大连接数， 默认值为maxConnections 10000(同步器 AQS 实现)
    ...
    protected boolean setSocketOptions(SocketChannel socket) {
        ...
        try {
            ...
            /**
             * nioChannels 是一个栈，如果缓存中存在则直接拿过来就用，否则初始化一个 {@link NioChannel}
             */
    ...
    public class Poller implements Runnable {
        ...
        /**
         * Poller 线程不断地轮询 selector，检查准备就绪的 socket，实现 io 的多路复用。其初始化 selector
         *
         * @throws IOException
         */
        ...
        protected void processKey(SelectionKey sk, NioSocketWrapper attachment) {
            try {
                if (close) {
                    ...
                    /**
                     * {@link Poller#register(NioChannel)}
                     */
                    if (sk.isReadable() || sk.isWritable()) {
                        if (attachment.getSendfileData() != null) {
                            processSendfile(sk, attachment, false);
                        } else {
                            // 为 NioSocketWrapper 设置 interestOps 参数
     ...
     *
     * 这个类相当于Worker，但只是在外部Executor线程池中使用。
     */
