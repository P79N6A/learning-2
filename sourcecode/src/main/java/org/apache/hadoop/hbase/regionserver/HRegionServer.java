...
public class HRegionServer extends HasThread implements
    ...
    private boolean areAllUserRegionsOffline() {
        ...
        for (Entry<String, HRegion> e : this.onlineRegions.entrySet()) {
    ...
    void closeMetaTableRegions(final boolean abort) {
        ...
        try {
            for (Entry<String, HRegion> e : onlineRegions.entrySet()) {
                RegionInfo hri = e.getValue().getRegionInfo();
                if (hri.isMetaRegion()) {
                    meta = e.getValue();
                }
    ...
    protected void cleanMovedRegions() {
        ...
        while (it.hasNext()) {
            Entry<String, MovedRegionInfo> e = it.next();
    ...
    private boolean isHealthCheckerConfigured() {
        ...
        return StringUtils.isNotBlank(healthScriptLocation);
    }
