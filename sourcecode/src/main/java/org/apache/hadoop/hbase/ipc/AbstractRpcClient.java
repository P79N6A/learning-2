...
public abstract class AbstractRpcClient<T extends RpcConnection> implements RpcClient {
   ...
   * {@link PoolMap.PoolType#RoundRobin} or
   * {@link PoolMap.PoolType#ThreadLocal}, otherwise default to the
   ...
   * of {@link RpcClient} instances should not exceed the operating
   * system's hard limit on the number of connections.
   * @param config configuration
   * @return either a {@link PoolMap.PoolType#RoundRobin} or
   ...
   * is {@link PoolMap.PoolType#RoundRobin}.
   * @param config configuration
